                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        foreach ($usuarios_datos as $usuarios_dato){
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $usuarios_dato['cedula'];?></td>
                                                <td><?php echo $usuarios_dato['email'];?></td>
                                                <td><?php echo $usuarios_dato['rol'];?></td>
                                                <td><?php echo $usuarios_dato['fyh_creacion'];?></td>
                                                <td><center>
                                                        <div class="btn-group">
...
if (isset($_SESSION['mensaje'])){
    ...
    <script>
        Swal.fire({
            icon: "success",
            title: "<?php echo $respuesta; ?>",
            text: "¡El usuario se elimino permanentemente!",
        })
    </script>
    <?php
}
    ...
    $(function () {
        $("#example1").DataTable({
            ...
            language: {
                ...
                "decimal": "",
                "info": "Mostrando De 1 a 5 Usuarios",
